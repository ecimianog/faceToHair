...
Builder.load_file("resultScreen2.kv")
class ResultScreen2(MDScreen):
	def __init__(self, crum, valor,**kwargs):
		super(ResultScreen2,self).__init__(**kwargs)
		# GET SELECTOR FROM KV FILE CAMERA
		print(valor)
		self.myimage =  self.ids.image
		self.myimage.source = valor
		print(crum)
		self.mybox = self.ids.name2
		self.mybox1 = self.ids.name3
